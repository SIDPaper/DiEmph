...
import copy
from diemph_utils.asm_parser import ishexnumber, ispurenumber, isaddr
...
class Instruction:
    ...
    def __init__(self, code: str, id: int):
        ...
        if operator in set(['push']):
            ...
            self.uses.append("rsp")            
            self.defs.append("rsp")
...
class Function:
    ...
    def __init__(self, cfg:nx.classes.digraph.DiGraph):
        self.cfg = cfg
        self.addr2our_bb = {}
        # only include the first 150 instructions
        instr_cnt = 0        
