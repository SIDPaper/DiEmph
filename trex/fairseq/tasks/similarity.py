...
class SimilarityTask(LegacyFairseqTask):
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        for field in configs.fields:
            ...
            input0[field] = PrependTokenDataset(input0[field], self.source_dictionary[field].bos())
            input1[field] = PrependTokenDataset(input1[field], self.source_dictionary[field].bos())
