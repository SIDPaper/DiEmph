...
from diemph_utils import prog_model, prog_model_stack, prog_model_no_analysis
...
def analyze_one_cfg(model, current_func):  
  ...
  importance_analysis = prog_model_no_analysis.InstructionImportanceAnalysis(current_func)
